...
import { Eye, Mail, Save, AlertCircle, Loader2, FileText, Trash2, Plus, Minus, ArrowUp, ArrowDown, Type, Printer, HelpCircle, MessageCircle, X, Users, UserPlus, FileDown, Building2, Send, CheckCircle2, XCircle } from 'lucide-react';
...
// ── BroadcastLetterDialog (inlined to avoid production circular-dep crash) ───

// Dynamic imports for broadcast services
...
function BroadcastLetterDialog({
  open,
  onOpenChange,
  letterContent,
  originalBodyContent,
  ...
  }, [getUniqueEmails, showCommercialName, commercialName, emailSubject, includesPayment, calculateDiscounts, amount, subjectLines]);

  const sendPersonalized = useCallback(async (
    content: string,
    headerLines: CustomHeaderLine[],
    accessToken: string
  ) => {
  ...
  }, [recipientSummary, showCommercialName, commercialName, emailSubject, includesPayment, calculateDiscounts, amount, subjectLines]);
