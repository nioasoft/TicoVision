...
export function ForeignWorkersPage() {
  ...
  const isSharedDataComplete =
    ...
    formState.sharedData.accountant_name;
  ...
  const isCurrentTabComplete = () => {
    ...
    switch (tab.templateType) {
      ...
      case 'foreign_worker_accountant_turnover':
        return (
          !!formState.documentData.accountantTurnover.company_type &&
  ...
  const handleGenerateDocument = async () => {
    ...
    try {
      ...
      // TODO: Open preview dialog or navigate to document
      console.log('Generated document:', result.data);
    } catch (error) {
