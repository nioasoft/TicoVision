-- Migration: Fix create_user_with_role to lookup tenant from user_tenant_access
-- Purpose: Resolve 404 error when approving user registrations
-- Issue: Function was trying to read tenant_id from JWT which may be missing
-- Solution: Query user_tenant_access table instead of relying on JWT metadata
-- Date: 2025-10-30
...
-- Recreate function with improved tenant lookup logic
