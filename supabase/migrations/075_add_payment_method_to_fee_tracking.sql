-- ================================================
-- Migration: Add Payment Method Selection to Fee Tracking
-- Date: 2025-01-12
-- Description:
--   Update get_fee_tracking_data() to return payment method selection fields
--   This allows the Fee Tracking dashboard to show which payment method the client selected
-- ================================================

-- Drop the existing function first
DROP FUNCTION IF EXISTS get_fee_tracking_data(UUID, INT);

-- Recreate with additional payment method fields
...
RETURNS TABLE (
  ...
  -- NEW: Payment method selection fields
...
BEGIN
  ...
  SELECT
    ...
    -- NEW: Payment method selection (from fee_calculations table)
