...
## הנחיות מיוחדות לעברית:
- שים לב לאותיות דומות: ה↔ח, כ↔ב, ר↔ד, ו↔ז, ן↔ף, ם↔ס, ע↔צ
- בדוק שם החברה אות אות - טעות אחת משנה את כל השם
- מספר ח.פ. חייב להיות בדיוק 9 ספרות
- אם יש ספק - העדף את הגרסה ההגיונית יותר (למשל "הנדסה" ולא "חנדסה", "חברה" ולא "הברה")
- שמות חברות נפוצים כוללים: בע"מ, ייזום, נדל"ן, החזקות, השקעות, שירותים, סחר, הנדסה, יעוץ, תקשורת, טכנולוגיות
...
- ערים נפוצות: תל אביב, ירושלים, חיפה, נתניה, רמת גן, פתח תקווה, באר שבע, אשדוד, הרצליה, רעננה, ראשון לציון, כפר סבא, חולון, בת ים, גבעתיים, רמת השרון, מודיעין, אשקלון, רחובות
